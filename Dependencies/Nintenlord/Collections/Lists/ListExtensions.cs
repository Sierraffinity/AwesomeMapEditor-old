...
namespace Nintenlord.Collections.Lists
{
    public static class ListExtensions
    {
        ...
        {
            list.SelectionSort<T>(Comparer<T>.Default);
        }
        ...
        {
            list.InsertionSort<T>(Comparer<T>.Default);
        }
        ...
        {
            list.ShellSort<T>(Comparer<T>.Default);
        }
        ...
        {
            list.CombSort<T>(Comparer<T>.Default);
        }
        ...
        {
            list.MergeSort<T>(Comparer<T>.Default);
        }
        ...
        public static int OrderedIndexOf<T>(this IList<T> list, T item, IComparer<T> comp)
        {
            int i;
            for (i = 0; i < list.Count; i++)
            {
                if (comp.Compare(list[i], item) > 0)
                {
        ...
        public static int OrderedIndexOf<T>(this IList<T> list, T item)
            where T : IComparable<T>
        {
            return OrderedIndexOf(list, item, Comparer<T>.Default);
        }
