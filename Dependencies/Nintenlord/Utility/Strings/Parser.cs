...
namespace Nintenlord.Utility
{
    public class Parser
    {
        ...
        {
            return EvaluateReversePolishNotation<int, string>(
        ...
        public static bool RemoveComments(ref string line, ref int blockCommentDepth)
        {
            if (line.Length == 0)
                return true;
            ...
            if (Array.ConvertAll<int, bool>(commentDepths, x => x == 0).And())
            {
                //No block comments
