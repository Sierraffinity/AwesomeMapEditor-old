...
namespace Nintenlord.ROMHacking.GBA.Compressions
{
    public static unsafe class LZ77
    {
        ...
        public static int[] Scan(BinaryReader br, int offset, int amount, int sizeMultible, int minSize, int maxSize)
        {
        ...
        /// <returns></returns>
        public static int[] Scan(byte[] data, int offset, int amount, int sizeMultible, int minSize, int maxSize)
        {
        ...
        /// <returns>An array of offsets relative to the beginning of scan area</returns>
        public static int[] Scan(byte* pointer, int amount, int sizeMultible, int minSize, int maxSize)
        {
        ...
        public static bool CanBeUnCompressed(BinaryReader br, int offset, int minSize, int maxSize)
        {
        ...
        /// <returns>True if data can be uncompressed, else false</returns>
        public static bool CanBeUnCompressed(byte* source, int minSize, int maxSize)
        {
        ...
        /// <returns>True if data can be uncompressed, else false</returns>
        public static bool CanBeUnCompressed(byte[] data, int offset, int minSize, int maxSize)
        {
            bool result;
        ...
        public static int GetCompressedDataLenght(BinaryReader br, int offset)
        {
            int lenght = 0;
            int UncompSize = 0;
            br.BaseStream.Position = offset;
        ...
        /// <returns>Returns lenght or -1 if can't be uncompressed</returns>
        public static int GetCompressedDataLenght(byte[] data, int offset)
        {
            fixed (byte* ptr = &data[offset])
            {
        ...
        /// <returns>Compressed data</returns>
        public static byte[] Compress(byte[] data, int index, int length)
        {
        ...
        /// <returns>Compressed data</returns>
        public static byte[] Compress(BinaryReader br, int offset, int lenght)
        {
        ...
        /// <param name="lenght">Length of the data to compress</param>
        /// <returns>Compressed data</returns>
        public static byte[] Compress(BinaryReader br, int lenght)
        {
            byte[] uncompressedData;
            if (br.BaseStream.Length < br.BaseStream.Position + lenght)
                return null;
        ...
        /// <returns>Compressed data</returns>
        public static byte[] Compress(byte* source, int lenght)
        {
            int position = 0;
        ...
        /// </summary>
        /// <param name="writer">Stream to write compressed data to</param>
        /// <param name="reader">Stream to compress data from</param>
        /// <param name="length">Amount of data to compress</param>
        public static void CompressTo(BinaryWriter writer, BinaryReader reader, int length)
        {
            writer.Write(Compress(reader, length));
        }
        ...
        public static bool Decompress(byte* source, byte* target)
        {
            if (*source++ != 0x10)
                return false;
        ...
        /// <param name="offset">Offset of the compressed data in the stream</param>
        /// <returns>Decompressed data or null if decompression fails</returns>
        public static byte[] Decompress(BinaryReader br, int offset)
        {
            br.BaseStream.Position = offset;
        ...
        /// <returns>True if successful, else false</returns>
        public static bool Decompress(BinaryReader br, int offset, byte* destination)
        {
            br.BaseStream.Position = offset;
            int size = br.ReadInt32();
            ...
            while ((uncompPosition < size) && (br.BaseStream.Position < br.BaseStream.Length))
            {
                ...
                for (int i = 0; i < BlockSize && uncompPosition < size && br.BaseStream.Position < br.BaseStream.Length; i++)
                {
                    if ((isCompressed & 0x80) != 0)
                    {
                        ...
                        for (int u = 0; u < AmountToCopy; u++)
                            destination[uncompPosition + u] = destination[uncompPosition - u - Position + (u % Position)];
